...
Thanks for using rcamelspe! Before filing an issue, there are a few
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/pefrens/rcamelspe/issues/new).
...
requests](https://github.com/pefrens/rcamelspe/issues) to make sure the
